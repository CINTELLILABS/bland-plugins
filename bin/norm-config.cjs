 ...
 * `~/.claude/settings.json` → pluginConfigs["bland@bland"].options.bland_api_url —
...
// different qualified id (e.g. "bland@bland-local"), and pre-2.0 installs under
// "norm@*": target whichever entry already exists so we edit the config the
// MCP client actually reads.
const existingId =
	(configs[PLUGIN_ID] && PLUGIN_ID) ||
	Object.keys(configs).find((id) => id.startsWith("bland@")) ||
